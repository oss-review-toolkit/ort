...
* Contributors MUST maintain human oversight over the entire contribution process.
  All commits MUST be signed off by a human user, not an AI bot.
...
* Contributors MUST fully understand the submitted code by the time they make the PR ready for review and be capable of explaining how and why the changes work.
