...
import com.here.ort.model.MarkingExcludesProcessor
import com.here.ort.model.OrtResult
import com.here.ort.model.ProjectAnalyzerResult
import com.here.ort.model.RemovingExcludesProcessor
        ...
        val analyzerResult = analyzerResultBuilder.build().let { analyzerResult ->
            repositoryConfiguration.excludes?.let { excludes ->
                val excludesProcessor = if (config.removeExcludesFromResult) {
                    RemovingExcludesProcessor(excludes)
                } else {
                    MarkingExcludesProcessor(excludes)
                }
