...
class Conda(
    ...
    override fun resolveDependencies(definitionFile: File): ProjectAnalyzerResult? {
        ...
        // TODO: Pip.kt tried some fancy logic parsing out project names from the environment file. skip it for now.
        val requirementsVersion = VersionControlSystem.getCloneInfo(workingDir).revision
        val projectName = setupName  // could in-line if we don't do environment file parsing like in pip
        ...
        if (pipdeptree.isSuccess) {
            // convert stdout to lower case due to inconistent cases coming back from pipdeptree
            val fullDependencyTree = jsonMapper.readTree(pipdeptree.stdout.toLowerCase())
