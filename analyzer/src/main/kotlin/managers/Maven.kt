...
object Maven : PackageManager(
    ...
    override fun prepareResolution(definitionFiles: List<File>) {
        // TODO do not resolve dependencies here, to only build models?
    ...
    override fun resolveDependencies(projectDir: File, workingDir: File, definitionFile: File): AnalyzerResult? {
        ...
        System.setProperty("maven.home", "/home/martin/.m2")
        ...
        val project = Project(
                ...
                declaredLicenses = mavenProject.licenses.map { it.name }.toSet(),
                aliases = emptyList(),
                vcsPath = "",
