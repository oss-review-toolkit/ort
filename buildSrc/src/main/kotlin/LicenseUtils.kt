...
object CopyrightableFiles {
    private val excludedPaths = listOf(
        ...
        "gradlew",
        "gradle/",
        "docs/configuration/_category_.yml",
        "docs/getting-started/_category_.yml",
        "docs/guides/_category_.yml",
        "docs/plugins/_category_.yml",
        "docs/plugins/advisors/_category_.yml",
        "docs/plugins/license-fact-providers/_category_.yml",
        "docs/plugins/package-configuration-providers/_category_.yml",
        "docs/plugins/package-curation-providers/_category_.yml",
        "docs/plugins/package-managers/_category_.yml",
        "docs/plugins/reporters/_category_.yml",
        "docs/plugins/scanners/_category_.yml",
...
object CopyrightUtils {
    const val EXPECTED_HOLDER =
        "The ORT Project Copyright Holders <https://github.com/oss-review-toolkit/ort/blob/main/NOTICE>"
