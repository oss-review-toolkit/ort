...
object ReporterCommand : CommandWithHelp() {
    ...
    @Parameter(
        description = "A directory which maps custom license IDs to license texts. " +
                "It should contain one text file per license with the license ID as filename." +
                "A custom license text is used only if its ID has 'LicenseRef-' as prefix and if " +
