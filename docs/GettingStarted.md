...
generate both, the static HTML report and theExcel record, use:

```bash
reporter/build/install/reporter/bin/reporter  -f STATIC_HTML,EXCEL-s [scanner-output-path]/mime-types/scan-record.yml -o [reporter-ouput-path]/mime-types
Writing static HTML report to '/home/martin/reports/mime-types/scan-report.html'.
Writing Excel report to '/home/martin/reports/mime-types/scan-report.xlsx'.
```
