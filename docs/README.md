...
# ORT Prerequisiteseneric-repository-name"
...
ORT is able to detect the following package managers/build sfollowing YAML file contains the configuration of an Artifactory cache:
 ystems and query them for depedencies:
