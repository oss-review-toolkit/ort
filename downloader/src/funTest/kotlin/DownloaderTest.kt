...
class DownloaderTest : StringSpec() {
    ...
    init {
        "Downloads subpath of package from git" {
        ...
        "Downloads single revision of package from git" {
            ...
            val workingDir = getWorkingDir(Git, pkg)

            workingDir.getRevision() shouldBe revision
        }.config(tags = setOf(Expensive))
