...
class MercurialTest : StringSpec() {
    ...
    init {
        ...
        "Mercurial can download single revision" {
            ...
            val downloadedRev = Mercurial.download(repoUrl, revision, null, "", outputDir)
        ...
        "Mercurial can download version" {
            ...
            val downloadedRev = Mercurial.download(repoUrl, null, null, version, outputDir)
            downloadedRev shouldBe revision1_1
        }.config(tags = setOf(Expensive))
    }
}
