...
abstract class WorkingTree(val workingDir: File, val vcsType: VcsType) {
     ...
     */
    open fun getInfo() = VcsInfo(vcsType, getRemoteUrl(), getResolvedRevision(), path = getPathToRoot(workingDir))
    ...
    /**
     * Return the VCS-specific working tree resolved revision.
     */
    abstract fun getResolvedRevision(): String
