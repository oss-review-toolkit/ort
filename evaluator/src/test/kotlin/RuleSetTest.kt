    ...
    init {
        "package rule" should {
            "add errors if it has no requirements" {
                ...
                ruleSet.issues should haveSize(allPackages.size + allProjects.size)
            }
            ...
            "add errors only if all requirements are met" {
                ...
                println("issues:\n${ruleSet.issues}")
                ruleSet.issues should haveSize(2)
            }
            ...
            "add license errors only if all requirements are met" {
                ...
                ruleSet.issues should haveSize(1)
            }
        }
        ...
        "dependency rule" should {
            "add errors if it has no requirements" {
                ...
                ruleSet.issues should haveSize(allPackages.size)
            }
