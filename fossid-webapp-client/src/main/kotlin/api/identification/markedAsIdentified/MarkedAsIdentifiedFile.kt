...
class MarkedAsIdentifiedFile : Summarizable {
    ...
    var identificationCopyright: String? = null

    @JsonProperty("is_distributed")
    var isDistributed: Int? = null
    ...
    var component: Component? = null // TODO how to get the additional components ? Only one is returned
