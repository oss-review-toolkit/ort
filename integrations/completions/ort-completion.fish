...
complete -c ort -n "__fish_seen_subcommand_from report" -l license-categories-to-include -r -d 'The licenses of the packages have to be categorized with one of these categories, specified as comma-separated values.'
