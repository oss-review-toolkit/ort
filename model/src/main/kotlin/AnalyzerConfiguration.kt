...
data class AnalyzerConfiguration(
         ...
         * (transitive) dependencies are declared using version ranges and a new version of this dependency was
         * published in the meantime. This is implicitly true for package managers that do not support lock files but
         * that do support version ranges. If set to false, analysis of projects that use version ranges will fail.
         */
