...
class MarkingExcludesProcessor(excludes: Excludes) : ExcludesProcessor(excludes) {
...
class RemovingExcludesProcessor(excludes: Excludes) : ExcludesProcessor(excludes) {
    override fun processProject(
            project: Project,
            projectExclude: ProjectExclude?,
            excludedScopes: MutableList<ScopeExclude>,
