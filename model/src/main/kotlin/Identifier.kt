...
data class Identifier(
    ...
    private val list = listOf(provider, namespace, name, version)

    init {
        require(list.none { ":" in it }) {
     ...
     */
    fun toPath() = list.joinToString("/") { it.encodeOrUnknown() }

    // TODO: Consider using a PURL here, see https://github.com/package-url/purl-spec#purl.
    override fun toString() = list.joinToString(":") { it.trim().filterNot { it < ' ' } }
}
