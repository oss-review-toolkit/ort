...
data class OrtResult(
    ...
    /**
     * Conveniently return all projects and packages that are likely to belong to the vendor of the given [name].
     * Projects are converted to packages in the result. An empty set is returned if no analyter result is present.
     */
    ...
    /**
     * Conveniently return the declared licenses for the given [id] which may either refer to a project or to a package.
     */
