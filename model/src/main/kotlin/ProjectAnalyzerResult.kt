...
data class ProjectAnalyzerResult(
        ...
        val errors: List<OrtError> = emptyList()
) {
    init {
    ...
    fun collectErrors(): Map<Identifier, List<OrtError>> {
        val collectedErrors = mutableMapOf<Identifier, MutableList<OrtError>>()
        ...
        return mutableMapOf<Identifier, List<OrtError>>().apply {
