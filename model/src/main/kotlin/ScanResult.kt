...
data class ScanResult(
    ...
    /**
     * Filter all detected licenses and copyrights from the [summary] which are below [path], and set the [path] for
     * [provenance]. Findings in files which are listed in [LICENSE_FILE_NAMES] are also kept.
     */
