...
data class Stats(
    /**
     * The number of [OrtIssue]s by severity.
     */
    val technicalIssues: IssueStats,
    /**
     * The number of [RuleViolation]s by severity.
     */
    val policyViolations: IssueStats,
    /**
     * Stats for the dependency tree.
     */
    val dependencyTree: DependencyTreeStats
)
...
/**
 * A class containing stats about the dependency trees.
 */
data class DependencyTreeStats(
    /**
