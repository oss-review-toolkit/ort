...
data class ResolvedLicenseInfo(
     ...
     * excluded by [PathExclude]s are [omitted][omitExcluded], Copyright statements that do not have a holder are
     * [omitted][omitEmptyHolders], and Copyrights are [processed][process] using the [CopyrightStatementsProcessor].
     */
    @JvmOverloads
    fun getCopyrights(process: Boolean = true, omitExcluded: Boolean = true, omitEmptyHolders: Boolean = true): Set<String> {
