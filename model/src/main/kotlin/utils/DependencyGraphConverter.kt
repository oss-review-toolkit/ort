...
object DependencyGraphConverter {
    ...
    fun convert(
        ...
        return result.copy(
            ...
            projects = result.projects.mapTo(mutableSetOf()) { it.convertToScopeNames(includes, excludes) },
     ...
     * scope names. Use the given [includes] and [excludes] to filter out excluded scopes. Return the same project if
     * this format is already in use.
     */
    private fun Project.convertToScopeNames(includes: Includes, excludes: Excludes): Project =
