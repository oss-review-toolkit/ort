...
class ScanResultsTest : WordSpec() {
    ...
    private val scanResult1 =
            ScanResult(provenance1, scannerSpecs1, scanSummary1, rawResult1)
    private val scanResult2 =
            ScanResult(provenance2, scannerSpecs2, scanSummary2, rawResult2)

    private val scanResults = ScanResults(id, listOf(scanResult1, scanResult2))
        ...
        "ScanResults" should {
            "be serializable and deserializable" {
                ...
                val deserializedScanResults =
                        jsonMapper.readValue(serializedScanResults, ScanResults::class.java)
