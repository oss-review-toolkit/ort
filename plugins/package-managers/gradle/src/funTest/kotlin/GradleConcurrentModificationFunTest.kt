...
class GradleConcurrentModificationFunTest : FunSpec({
    withData(
        ...
        val definitionFile = getAssetFile("projects/synthetic/gradle-concurrent-modification/build.gradle")
        val expectedResultFile =
            getAssetFile("projects/synthetic/gradle-concurrent-modification-expected-output.yml")
