...
class GradleLateRepositoryFunTest : FunSpec({
    withData(
        ...
        val definitionFile = getAssetFile("projects/synthetic/gradle-late-repository/build.gradle")
        val expectedResultFile =
            getAssetFile("projects/synthetic/gradle-late-repository-expected-output.yml")
