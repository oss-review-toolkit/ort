...
class Poetry(
    ...
    override fun resolveDependencies(definitionFile: File, labels: Map<String, String>): List<ProjectAnalyzerResult> {
        val mainDependenciesResult = inspectLockfile(definitionFile, mainGroup = true)
        val devDependenciesResult = inspectLockfile(definitionFile, mainGroup = false)
     ...
     * in [lockfile] via the `poetry export` command. If [mainGroup] is true, only main group gets inspected. Otherwise,
     * dev dependencies without main group get inspected.
     */
    private fun inspectLockfile(lockfile: File, mainGroup: Boolean): PythonInspector.Result {
