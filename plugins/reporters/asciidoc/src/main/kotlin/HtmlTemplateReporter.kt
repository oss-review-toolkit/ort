...
/**
 * A [Reporter] that creates HTML files from [Apache Freemarker](https://freemarker.apache.org) templates.
 */
@OrtPlugin(
    displayName = "HTML Template",
    summary = "Generates HTML from AsciiDoc files from Apache Freemarker templates.",
