...
[#-- @ftlvariable name="projects" type="java.util.Set<org.ossreviewtoolkit.plugins.reporters.freemarker.FreemarkerTemplateProcessor.PackageModel>" --]
[#-- @ftlvariable name="packages" type="java.util.Set<org.ossreviewtoolkit.plugins.reporters.freemarker.FreemarkerTemplateProcessor.PackageModel>" --]
...
[#-- @ftlvariable name="projectsAsPackages" type="java.util.Set<org.ossreviewtoolkit.model.Identifier>" --]
