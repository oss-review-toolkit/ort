...
class SpdxDocumentReporterFunTest : WordSpec({
    "Reporting to SPDX-2.2" should {
        ...
        "create the expected JSON document for a synthetic scan result" {
            ...
            val jsonSpdxDocument = generateReport(ORT_RESULT, FileFormat.JSON, SpdxVersion.`SPDX-2.2`)
        ...
        "create the expected YAML document for a synthetic scan result" {
            ...
            val yamlSpdxDocument = generateReport(ORT_RESULT, FileFormat.YAML, SpdxVersion.`SPDX-2.2`)
    ...
    "Reporting to SPDX-2.3" should {
        ...
        "create the expected JSON document for a synthetic scan result" {
            ...
            val jsonSpdxDocument = generateReport(ORT_RESULT, FileFormat.JSON, SpdxVersion.`SPDX-2.3`)
        ...
        "create the expected YAML document for a synthetic scan result" {
            ...
            val yamlSpdxDocument = generateReport(ORT_RESULT, FileFormat.YAML, SpdxVersion.`SPDX-2.3`)
