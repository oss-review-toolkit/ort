...
// The dependency graph view: an expandable tree of scopes and their (transitive) packages.
...
/**
 * Gates the dependency graph view on the model's asynchronous, chunked tree construction. Large reports build
