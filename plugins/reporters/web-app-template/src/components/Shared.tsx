...
export const LICENSE_TERM_DEFINITIONS = {
    ...
    declaredNonSpdx: "Declared licenses that could not be mapped to an SPDX expression.",
    declaredSpdx: "Licenses from package metadata mapped to an SPDX expression.",
