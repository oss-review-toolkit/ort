...
/**
 * The configuration for the REUSE scanner.
 */
data class ReuseConfig(
    /**
     * If true, do not skip over Git submodules.
     */
    @OrtPluginOption(defaultValue = "false")
    val includeSubmodules: Boolean,

    /**
     * If true, do not skip over Meson subprojects.
     */
    @OrtPluginOption(defaultValue = "false")
    val includeMesonSubprojects: Boolean,
