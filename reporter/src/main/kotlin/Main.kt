...
object Main {
    ...
    private var scanRecordFile: File? = null
    ...
    @Parameter(description = "The list of report formats that will be generated.",
            names = ["--report-format", "-f"],
            converter = ReportFormatConverter::class,
            order = PARAMETER_ORDER_MANDATORY)
    private var reportFormats = listOf<ReportFormat>()
    ...
    fun main(args: Array<String>) {
        ...
        } ?: throw IllegalArgumentException("Could not read scan record from '$scanRecordFile'.")
    }
}
