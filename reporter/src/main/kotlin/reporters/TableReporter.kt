...
abstract class TableReporter : Reporter {
    data class TableizedScanRecord(
            /**
    ...
    data class TableEntry(
        ...
        fun merge(other: TableEntry) =
                TableEntry(
                        ...
                        analyzerErrors = analyzerErrors + other.analyzerErrors,
                        scanErrors = scanErrors + other.scanErrors
                )
    }
    ...
    override fun generateReport(scanRecord: ScanRecord, outputDir: File) {
        ...
        generateReport(TableizedScanRecord(summaryTable, projectTables), outputDir)
    }

    abstract fun generateReport(tableizedScanRecord: TableizedScanRecord, outputDir: File)
}
