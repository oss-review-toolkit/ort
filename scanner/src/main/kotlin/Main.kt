...
object Main {
    ...
    @Parameter(description = "The output directory for downloaded source code. Defaults to output-dir/download.",
    ...
    fun main(args: Array<String>) {
        ...
        require(downloadDir.let { it == null || !it.exists() }) {
            "The download directory '${downloadDir?.absolutePath}' must not exist yet."
        }
