...
object Main {
    ...
    @Parameter(description = "The list of scopes that shall be scanned for licenses. Works only with the " +
    ...
    fun main(args: Array<String>) {
        ...
        dependenciesFile?.let { dependenciesFile ->
            ...
            if (includeScopes.isNotEmpty()) {
                ...
                packages.addAll(analyzerResult.packages.filter { pkg -> includedScopes.any { it.contains(pkg) } })
            } else {
