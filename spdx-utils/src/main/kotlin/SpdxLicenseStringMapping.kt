...
object SpdxLicenseStringMapping {
    private val mapping = mapOf(
            ...
            "3-clause BSD" to BSD_3_CLAUSE.toExpression(),
            "AFLv2.1" to AFL_2_1.toExpression(),
            "AL 2.0" to APACHE_2_0.toExpression(),
            "ALv2" to APACHE_2_0.toExpression(),
            "APL2" to APACHE_2_0.toExpression(),
            "APLv2.0" to APACHE_2_0.toExpression(),
            "ASF 2.0" to APACHE_2_0.toExpression(),
            "ASL" to APACHE_2_0.toExpression(),
            ...
            "Apache" to APACHE_2_0.toExpression(),
 ...
 """.trimIndent() to APACHE_2_0.toExpression(),
            "Apache2" to APACHE_2_0.toExpression(),
            "Artistic 2.0" to ARTISTIC_2_0.toExpression(),
            "BOOST" to BSL_1_0.toExpression(),
            "BSD" to BSD_2_CLAUSE.toExpression(),
            ...
            "BSD-style" to BSD_3_CLAUSE.toExpression(),
            "BSD-style license" to BSD_3_CLAUSE.toExpression(),
            "BSD2" to BSD_2_CLAUSE.toExpression(),
            "BSD3" to BSD_3_CLAUSE.toExpression(),
            ...
            "CC0" to CC0_1_0.toExpression(),
            "CC0 1.0 Universal" to CC0_1_0.toExpression(),
            "CC0 1.0 Universal License" to CC0_1_0.toExpression(),
            "CDDL" to CDDL_1_0.toExpression(),
            "CDDL + GPLv2 with classpath exception" to (CDDL_1_0 and (GPL_2_0 with CLASSPATH_EXCEPTION_2_0)),
            "CDDL 1.0" to CDDL_1_0.toExpression(),
            "CDDL 1.1" to CDDL_1_1.toExpression(),
            "CDDL License" to CDDL_1_0.toExpression(),
            "CDDL or GPL 2 with Classpath Exception" to (CDDL_1_0 or (GPL_2_0 with CLASSPATH_EXCEPTION_2_0)),
            "CDDL or GPLv2 with exceptions" to (CDDL_1_0 or (GPL_2_0 with CLASSPATH_EXCEPTION_2_0)),
            "CDDL v1.0 / GPL v2 dual license" to (CDDL_1_0 and GPL_2_0),
            "CDDL v1.1 / GPL v2 dual license" to (CDDL_1_0 and GPL_2_0),
            "CDDL+GPL" to (CDDL_1_0 and GPL_2_0),
            "CDDL+GPL License" to (CDDL_1_0 and GPL_2_0),
            "CDDL+GPLv2" to (CDDL_1_0 and GPL_2_0),
            "CDDL/GPLv2 dual license" to (CDDL_1_0 and GPL_2_0),
            "CDDL/GPLv2+CE" to (CDDL_1_0 and (GPL_2_0 with CLASSPATH_EXCEPTION_2_0)),
            ...
            "CPL" to CPL_1_0.toExpression(),
            "Cecill-C" to CECILL_C.toExpression(),
            "Common Development and Distribution License" to CDDL_1_0.toExpression(),
            ...
            "Dual License: CDDL 1.0 and GPL V2 with Classpath Exception" to (CDDL_1_0 and GPL_2_0),
            "Dual license consisting of the CDDL v1.1 and GPL v2" to (CDDL_1_1 and GPL_2_0),
            "EPL" to EPL_1_0.toExpression(),
            ...
            "FreeBSD" to BSD_2_CLAUSE_FREEBSD.toExpression(),
            "GNU Affero General Public License v3" to AGPL_3_0.toExpression(),
            "GNU GENERAL PUBLIC LICENSE Version 2, June 1991" to GPL_2_0.toExpression(),
            "GNU GPL v2" to GPL_2_0.toExpression(),
            "GNU General Lesser Public License (LGPL) version 2.1" to LGPL_2_1.toExpression(),
            "GNU General Public Library" to GPL_3_0.toExpression(),
            "GNU General Public License (GPL)" to GPL_3_0.toExpression(),
            "GNU General Public License (GPL), version 2, with the Classpath exception" to GPL_2_0.toExpression(),
            "GNU General Public License Version 2" to GPL_2_0.toExpression(),
            "GNU General Public License v2 or later (GPLv2+)" to GPL_2_0PLUS.toExpression(),
            "GNU General Public License v3 (GPLv3)" to GPL_3_0.toExpression(),
            "GNU General Public License v3 or later (GPLv3+)" to GPL_3_0PLUS.toExpression(),
            "GNU General Public License, Version 2 with the Classpath Exception"
                    to (GPL_2_0 with CLASSPATH_EXCEPTION_2_0),
            "GNU General Public License, Version 3" to GPL_3_0.toExpression(),
            "GNU General Public License, version 2 (GPL2), with the classpath exception"
                    to (GPL_2_0 with CLASSPATH_EXCEPTION_2_0),
            "GNU General Public License, version 2, with the Classpath Exception"
                    to (GPL_2_0 with CLASSPATH_EXCEPTION_2_0),
            "GNU LESSER GENERAL PUBLIC LICENSE" to LGPL_2_1.toExpression(),
            "GNU LESSER GENERAL PUBLIC LICENSE V3.0" to LGPL_3_0.toExpression(),
            "GNU LESSER GENERAL PUBLIC LICENSE Version 2.1" to LGPL_2_1.toExpression(),
            "GNU LESSER GENERAL PUBLIC LICENSE, Version 2.1" to LGPL_2_1.toExpression(),
            "GNU LGP (GNU General Public License), V2 or later" to LGPL_2_0PLUS.toExpression(),
            "GNU LGPL" to LGPL_2_1.toExpression(),
            "GNU LGPL (GNU Lesser General Public License), V2.1 or later" to LGPL_2_1PLUS.toExpression(),
            "GNU Lesser General Public Licence" to LGPL_2_1.toExpression(),
            "GNU Lesser General Public License" to LGPL_2_1.toExpression(),
            "GNU Lesser General Public License (LGPL)" to LGPL_2_1.toExpression(),
            "GNU Lesser General Public License (LGPL), Version 2.1" to LGPL_2_1.toExpression(),
            "GNU Lesser General Public License (LGPL), Version 3" to LGPL_3_0.toExpression(),
            "GNU Lesser General Public License 2.1" to LGPL_2_1.toExpression(),
            "GNU Lesser General Public License Version 2.1" to LGPL_2_1.toExpression(),
            "GNU Lesser General Public License Version 2.1, February 1999" to LGPL_2_1.toExpression(),
            "GNU Lesser General Public License v2 or later (LGPLv2+)" to LGPL_2_0PLUS.toExpression(),
            "GNU Lesser General Public License v3 (LGPLv3)" to LGPL_3_0.toExpression(),
            "GNU Lesser General Public License v3 or later (LGPLv3+)" to LGPL_3_0PLUS.toExpression(),
            "GNU Lesser General Public License v3+" to LGPL_3_0PLUS.toExpression(),
            "GNU Lesser General Public License, Version 2.1" to LGPL_2_1.toExpression(),
            "GNU Lesser General Public License, version 2.1" to LGPL_2_1.toExpression(),
            "GNU Lesser Public License" to LGPL_2_1.toExpression(),
            "GNU Library or Lesser General Public License (LGPL)" to LGPL_2_1.toExpression(),
            "GNU Public" to GPL_2_0.toExpression(),
            "GPL" to GPL_2_0.toExpression(),
            "GPL (with dual licensing option)" to GPL_2_0.toExpression(),
            "GPL 3" to GPL_3_0.toExpression(),
            "GPL v2 with ClassPath Exception" to (GPL_2_0 with CLASSPATH_EXCEPTION_2_0),
            "GPL version 2" to GPL_2_0.toExpression(),
            "GPL-2" to GPL_2_0.toExpression(),
            "GPL2" to GPL_2_0.toExpression(),
            "GPL2 w/ CPE" to (GPL_2_0 with CLASSPATH_EXCEPTION_2_0),
            "GPLv2" to GPL_2_0.toExpression(),
            "GPLv2+CE" to (GPL_2_0 with CLASSPATH_EXCEPTION_2_0),
            "GPLv3" to GPL_3_0.toExpression(),
            ...
            "LGPL" to LGPL_2_1.toExpression(),
            "LGPL 2.1" to LGPL_2_1.toExpression(),
            "LGPL 3" to LGPL_3_0.toExpression(),
            "LGPL 3.0" to LGPL_3_0.toExpression(),
            "LGPL v3" to LGPL_3_0.toExpression(),
            "LGPL with exceptions or ZPL" to (LGPL_3_0 or ZPL_2_1),
            "LGPL+BSD" to (LGPL_2_1 and BSD_2_CLAUSE),
            "LGPL, version 2.1" to LGPL_2_1.toExpression(),
            "LGPL-3" to LGPL_3_0.toExpression(),
            "LGPL/MIT" to (LGPL_3_0 and MIT),
            "LGPL3" to LGPL_3_0.toExpression(),
            "LGPLv3" to LGPL_3_0.toExpression(),
            "LGPLv3 or later" to LGPL_3_0PLUS.toExpression(),
            "LGPLv3+" to LGPL_3_0PLUS.toExpression(),
            "Lesser General Public License (LGPL)" to LGPL_2_1.toExpression(),
            "Lesser General Public License, version 3 or greater" to LGPL_3_0PLUS.toExpression(),
            ...
            "MIT licence" to MIT.toExpression(),
            "MIT license" to MIT.toExpression(),
            "MIT or GPLv3" to (MIT or GPL_3_0),
            "MIT, 2-clause BSD" to (MIT and BSD_2_CLAUSE),
            "MIT-like" to MIT.toExpression(),
            "MIT-style" to MIT.toExpression(),
            "MIT/Expat" to MIT.toExpression(),
            "MIT/X11" to (MIT and X11),
            "MPL" to MPL_2_0.toExpression(),
            ...
            "MPLv2.0" to MPL_2_0.toExpression(),
            ...
            "Mozilla Public License, Version 2.0" to MPL_2_0.toExpression(),
            "Mozilla Public License, version 2.0" to MPL_2_0.toExpression(),
            "NetBeans CDDL/GPL" to (CDDL_1_0 and GPL_2_0),
            ...
            "Ruby or LGPLv3+" to (RUBY or LGPL_3_0PLUS),
            ...
            "The GNU General Public License (GPL), Version 2, With Classpath Exception"
                    to (GPL_2_0 with CLASSPATH_EXCEPTION_2_0),
            "The GNU General Public License, Version 2" to GPL_2_0.toExpression(),
            "The GNU Lesser General Public License, Version 2.1" to LGPL_2_1.toExpression(),
            ...
            "UNLICENSE" to UNLICENSE.toExpression(),
            "UNLICENSED" to UNLICENSE.toExpression(),
            ...
            "http://www.gnu.org/copyleft/lesser.html" to LGPL_3_0.toExpression(),
            "lgpl" to LGPL_2_1.toExpression(),
            "new BSD" to BSD_3_CLAUSE.toExpression(),
            "public domain, Python, 2-Clause BSD, GPL 3 (see COPYING.txt)"
                    ...
                    and BSD_2_CLAUSE.toExpression()) and GPL_3_0.toExpression()),
            "ruby" to RUBY.toExpression(),
            "the Apache License, ASL Version 2.0" to APACHE_2_0.toExpression(),
            "wtfpl" to WTFPL.toExpression(),
            "zlib" to ZLIB.toExpression()
    )
