 ...
 *
 * @param definitionFilePath The path to the definition file relative to the analysis root.
 * @param defaultType The default identifier type to use if no PURL is present.
 */
 ...
 *
 * @return A pair of (declaredLicenses, declaredLicensesProcessed).
 */
...
internal fun Component.extractVcs(): VcsInfo {
    ...
    val (baseUrl, fragment) = vcsUrl.split('#', limit = 2).let {
