...
class OkHttpClientHelperTest : WordSpec({
    ...
    "LenientJavaNetAuthenticator" should {
        ...
        "query the Java authenticator" {
            ...
            val lenientAuthenticator = LenientJavaNetAuthenticator(mockk())
 ...
 */
private fun createResponse(code: Int = 401, originalRequest: Request? = null): Response {
