...
@Serializable(SpdxLicenseSerializer::class)
...
enum class SpdxLicense(
    ...
    ADVANCED_CRYPTICS_DICTIONARY("Advanced-Cryptics-Dictionary", "Advanced Cryptics Dictionary License"),
    ...
    ALGLIB_DOCUMENTATION("ALGLIB-Documentation", "ALGLIB Documentation License"),
    ...
    ATC_GAME("atc-game", "atc Game License"),
    ...
    BOLA_1_1("BOLA-1.1", "Buena Onda License Agreement v1.1"),
    ...
    BRIAN_GLADMAN_3_CLAUSE_NO_CONVERSION("Brian-Gladman-3-Clause-no-conversion", "Brian Gladman 3-Clause License (no conversion clause)"),
    ...
    BSD_2_CLAUSE_POS_UNCHANGED("BSD-2-Clause-pos-unchanged", "BSD 2-Clause - position unchanged variant"),
    ...
    BSD_3_CLAUSE_OPENWEBUI("BSD-3-Clause-OpenWebUI", "BSD 3-Clause - OpenWebUI variant"),
    ...
    BSD_3_CLAUSE_TSO("BSD-3-Clause-Tso", "BSD 3-Clause Tso variant"),
    ...
    BSD_ASK_TO_ENDORSE("BSD-ask-to-endorse", "BSD - ask to endorse"),
    ...
    BSD_MARK_MODIFICATIONS("BSD-Mark-Modifications", "BSD Mark Modifications License"),
    BSD_PROTECTION("BSD-Protection", "BSD Protection License"),
    BSD_SOURCE_ALT_GPL("BSD-Source-alt-GPL", "BSD Source Code Attribution - GPL alternative"),
    ...
    BSD_SOURCE_CODE_NO_DISCLAIMER("BSD-Source-Code-no-disclaimer", "BSD Source Code Attribution - no disclaimer"),
    ...
    BUDDY("Buddy", "Buddy License"),
    BUGROFF("Bugroff", "Bugroff License"),
    ...
    CAPEC_TOU("CAPEC-tou", "Common Attack    Pattern Enumeration and Classification License"),
    ...
    CC_BY_NC_3_0_IGO("CC-BY-NC-3.0-IGO", "Creative Commons Attribution Non Commercial 3.0 IGO"),
    ...
    ESA_PL_PERMISSIVE_2_4("ESA-PL-permissive-2.4", "European Space Agency Public License – v2.4 – Permissive (Type 3)"),
    ESA_PL_STRONG_COPYLEFT_2_4("ESA-PL-strong-copyleft-2.4", "European Space Agency Public License (ESA-PL) - V2.4 - Strong Copyleft (Type 1)"),
    ESA_PL_WEAK_COPYLEFT_2_4("ESA-PL-weak-copyleft-2.4", "European Space Agency Public License – v2.4 – Weak Copyleft (Type 2)"),
    ...
    FDK_MPEG_H("FDK-MPEG-H", "Fraunhofer FDK MPEG-H Software"),
    ...
    HIPPOCRATIC_3_0_CORE("Hippocratic-3.0-core", "Hippocratic License 3.0"),
    ...
    HPND_SELL_VARIANT_CRITICAL_SYSTEMS("HPND-sell-variant-critical-systems", "HPND - sell variant with safety critical systems clause"),
    ...
    HPND_SMC("HPND-SMC", "Historical Permission Notice and Disclaimer - SMC variant"),
    ...
    HYPHEN_BULGARIAN("hyphen-bulgarian", "hyphen-bulgarian License"),
    ...
    INFORMATICA("Informatica", "Informatica License"),
    ...
    ISO_PERMISSION("ISO-permission", "ISO permission notice"),
    JAM("Jam", "Jam License"),
    ...
    MUP("Mup", "Mup License"),
    MVT_1_1("MVT-1.1", "MVT License 1.1"),
    ...
    NIST_PD_TNT("NIST-PD-TNT", "NIST    Public Domain Notice TNT variant"),
    ...
    OPENMDW_1_0("OpenMDW-1.0", "OpenMDW License Agreement v1.0"),
    ...
    OSC_1_0("OSC-1.0", "OSC License 1.0"),
    ...
    OSSP("OSSP", "OSSP License"),
    O_UDA_1_0("O-UDA-1.0", "Open Use of Data Agreement v1.0"),
    PADL("PADL", "PADL License"),
    PARATYPE_FREE_FONT_1_3("ParaType-Free-Font-1.3", "ParaType Free Font Licensing Agreement v1.3"),
    ...
    SGMLUG_PM("SGMLUG-PM", "SGMLUG Parser Materials License"),
    ...
    WORDNET("WordNet", "WordNet License"),
    WSUIPA("Wsuipa", "Wsuipa License"),
    WTFNMFPL("WTFNMFPL", "Do What The F*ck You Want To But It's Not My Fault Public License"),
    ...
    X11_NO_PERMIT_PERSONS("X11-no-permit-persons", "X11 no permit persons clause"),
    ...
    companion object {
         ...
         */
        const val LICENSE_LIST_VERSION = "3.29.0"
...
internal object SpdxLicenseSerializer : KSerializer<SpdxLicense> by SpdxLicense.generatedSerializer() {
    override fun deserialize(decoder: Decoder): SpdxLicense {
        ...
        return checkNotNull(SpdxLicense.forId(node.content)) {
