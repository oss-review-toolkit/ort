...
@Serializable(SpdxLicenseExceptionSerializer::class)
...
enum class SpdxLicenseException(
    ...
    CLASSPATH_EXCEPTION_2_0_SHORT("Classpath-exception-2.0-short", "Classpath exception 2.0 - short"),
    ...
    GOOGLE_PATENT_WEBM("Google-Patent-WebM", "Google Additional IP Rights Grant (Patents) - WebM"),
    ...
    KVIRC_OPENSSL_EXCEPTION("kvirc-openssl-exception", "kvirc OpenSSL Exception"),
    ...
    RSYNC_LINKING_EXCEPTION("rsync-linking-exception", "rsync Linking Exception"),
    ...
    SIMPLE_LIBRARY_USAGE_EXCEPTION("Simple-Library-Usage-exception", "Simple Library Usage Exception"),
    SPELLING_PROVIDER_LGPL_EXCEPTION("Spelling-Provider-LGPL-exception", "Spelling Provider LGPL exception"),
    SQLITESTUDIO_OPENSSL_EXCEPTION("sqlitestudio-OpenSSL-exception", "sqlitestudio OpenSSL exception"),
...
internal object SpdxLicenseExceptionSerializer : KSerializer<SpdxLicenseException> by SpdxLicenseException.generatedSerializer() {
    override fun deserialize(decoder: Decoder): SpdxLicenseException {
        ...
        return checkNotNull(SpdxLicenseException.forId(node.content)) {
