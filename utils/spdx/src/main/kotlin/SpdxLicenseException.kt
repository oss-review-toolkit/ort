...
enum class SpdxLicenseException(
    ...
    companion object {
        ...
        val association by lazy {
            val resource = checkNotNull(this::class.java.getResourceAsStream("/exception-association.yml"))
            resource.use { yamlMapper.readValue<Map<String, List<SpdxLicense>>>(it) }
        }
