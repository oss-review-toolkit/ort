...
ORT supports two main ways to get license texts: [License Fact Providers](#license-fact-providers) and [License File Archives](#license-file-archives).
...
* [Default Directory License Fact Provider](../plugins/license-fact-providers/Default%20Custom%20License%20Texts%20Provider.md): Provides license texts from files the `$ORT_CONFIG_DIR/custom-license-texts` directory.
