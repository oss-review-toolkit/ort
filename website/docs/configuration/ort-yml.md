...
The includes and excludes can contradict each other e.g. if a path is
both included and excluded: in that case, after applying the includes and the excludes, it will be excluded.
