...
~~~json lines
{
  "$id": "ORT Project File Definition Schema",
  "$schema": "https://json-schema.org/draft/2020-12/schema",

  "title": "ort.project.schema.json",
  "type": "object",
  "properties": {
    "projectName": {
      "type": "string",
    ...
    "declaredLicenses": {
      "type": "array",
      "description": "List of declared licenses in SPDX format",
      "items": {
        "type": "string",
        "description": "Declared license in SPDX format"
      }
    },
    "authors": {
      "type": "array",
    ...
    "dependencies": {
      ...
      "items": {
        ...
        "properties": {
          "purl": {
            "type": "string",
            "description": "Package URL in purl format"
          },
          "id": {
            "type": "string",
            "description": "Package identifier in the 'ORT' format"
          },
          "description": {
            "type": "string",
            "description": "Package brief description"
          },
          "vcs": {
            "type": "object",
            "description": "Definition of the package's version control system location",
            "properties": {
              "type": {
                "type": "string",
              ...
              "revision": {
                "type": "string",
                "description": "VCS revision (branch)"
              },
              "path": {
                "type": "string",
                "description": "VCS path within the repository"
              }
            }
          },
          "sourceArtifact": {
            ...
            "properties": {
              "url": {
                "type": "string",
                "description": "URL to the source artifact"
              },
              "hash": {
                "type": "string",
                "description": "Hash of the source artifact"
              }
            }
          },
          "declaredLicenses": {
          ...
          "isModified": {
            "type": "boolean",
            "description": "Flag indicating whether the source code of the package has been modified compared to the original source code, e.g., in case of a fork of an upstream Open Source project",
            "default": false
          },
          "isMetadataOnly": {
            "type": "boolean",
            "description": "Flag indicating whether the package is just metadata, like e.g. Maven BOM artifacts which only define constraints for dependency versions",
            "default": false
          },
          "scopes": {
            "type": "array",
            "description": "List of scopes the package belongs to",
            "items": {
              "type": "string",
          ...
          "labels": {
            "type": "object",
            "description": "User defined labels associated with this package. The labels are not interpreted by the core of ORT itself, but can be used in parts of ORT such as plugins, in evaluator rules, or in reporter templates",
            "properties": {
              "label_key": {
                "type": "string",
                "description": "key-value pair for label"
              }
            }
          },
          "authors": {
