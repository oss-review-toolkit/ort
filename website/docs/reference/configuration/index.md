...
### [Copyright garbage file](copyright-garbage.md)
...
### [Custom license texts directory](license-texts-inclusion.md)
...
### [How to fix text provider script](how-to-fix-text-provider.md)
...
### [License classifications file](license-classifications.md)
...
### [Package configurations directory](package-configurations.md)

A directory with multiple files containing configurations to set provenance-specific path excludes and license finding curations for dependency packages to address issues found within a scan result.
...
| YAML / JSON | Global | `$ORT_CONFIG_DIR/package-curations/` |

### [Policy rules file](evaluator-rules.md)
...
### [Repository configuration file](ort-yml.md)
...
### [Resolution file](resolutions.md)
