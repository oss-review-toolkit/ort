...
ORT puts those snippets in the `SnippetFindings` property of the [ScanSummary][ScanSummary].
...
Hence, the user can control which snippets should be included in the ORT snippet results.
...
[ScanSummary]: https://github.com/oss-review-toolkit/ort/blob/main/model/src/main/kotlin/ScanSummary.kt
