...
export default function Toolchain() {
  const tools = [
    ...
    {title: 'Evaluator', Svg: EvaluatorSvg, description: 'Apply policy rules'},
  ...
  return (
    <section className={styles.toolchain}>
      <div className={styles.content}>
        <h1>ORT Toolchain</h1>
        <p>
          The <b>OSS Review Toolkit (ORT)</b> is a set of tools that work together to help you manage and analyze your
          software projects. It provides a comprehensive solution for Software Composition Analysis (SCA), license
          compliance, vulnerability management, and more, helping you to manage the risks in your software supply
          chain.
        </p>
      </div>
      <div className={styles.tools}>
        {tools.map((tool, index) => (
          <React.Fragment key={index}>
            <Tool {...tool} />
            {index < tools.length - 1 && <span className={styles.arrow}>&#8594;</span>}
          </React.Fragment>
        ))}
      </div>
      <div className={styles.content}>
        <p>
          Each tool in the ORT toolchain has a specific role, and you can use them individually or together to achieve
          your goals. The tools are designed to be modular and can be integrated into your existing workflows, whether
          you are working on a small project or a large enterprise application.
        </p>
        <p>
